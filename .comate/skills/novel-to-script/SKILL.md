...
- 音效仅限动作和环境声（如脚步声、关门声、风声、雨声等），禁止使用人声类音效（笑声、喊声、哭声、叹气、惊呼、喘息、冷哼等）；人声表达应通过角色配音的语气指导（`instruct`）来体现。
...
- 笑声、哭声、叹气、惊呼、喘息、冷哼等拟人发声不通过音效表现，应在 `instruct` 中通过语气指导体现。
...
人的笑声、喊声、哭声等情绪表达不应作为音效，应通过配音的语气指导（`instruct`）实现。音效仅用于非人声的动作声和环境声。
